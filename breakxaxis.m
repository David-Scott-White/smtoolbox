...
function breakInfo = breakxaxis(varargin)
    ...
    % adjust to make a straight line
    xPoints1 = amp * sin(theta)*0 + mainPosition(1) + leftWidthTemp;
    xPoints2 = amp * sin(theta)*0 + mainPosition(1) + mainPosition(3) - rightWidthTemp;
